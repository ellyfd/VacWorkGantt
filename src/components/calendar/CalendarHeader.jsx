  ...
  return (
    <div className="flex flex-col gap-4 mb-6">
      ...
      <div className="flex items-center gap-4 px-2">
        <span className="text-sm text-gray-600 min-w-[60px]">1月</span>
        <Slider
          value={[currentMonth]}
          onValueChange={(value) => handleMonthChange(value[0].toString())}
          min={0}
          max={11}
          step={1}
          className="flex-1"
        />
        <span className="text-sm text-gray-600 min-w-[60px] text-right">12月</span>
      </div>
    </div>
  );
}