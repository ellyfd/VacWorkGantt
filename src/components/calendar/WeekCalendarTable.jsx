    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      <div className="p-4 border-b border-gray-200 bg-gray-50">
        ...
        <div className="flex items-start justify-between gap-4 mb-2">
          {/* 左：姓名 */}
          <div>
            <h3 className="text-lg font-bold text-gray-800 leading-tight">{currentEmployee.name}</h3>
            {currentEmployee.english_name && (
              <div className="text-xs text-gray-500">{currentEmployee.english_name}</div>
            )}
          </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {onLeaveTypeChange && (
              <div className="flex items-center gap-2 flex-shrink-0 pl-2 border-l border-gray-300">
                <Select
