      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-4 md:mb-6">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-gray-800">假日管理</h1>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 w-24">日期</th>
                ...
                <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 w-20">編輯</th>
              </tr>
            </thead>
